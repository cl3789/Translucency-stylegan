...
DATASETS = {
	...
	'soap_encode': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['soap_train'],
		'train_target_root': dataset_paths['soap_train'],
		'test_source_root': dataset_paths['soap_test'],
		'test_target_root': dataset_paths['soap_test'],
	},
	'ffhq_frontalize': {
