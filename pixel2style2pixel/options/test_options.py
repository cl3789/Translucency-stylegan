...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--save_latent_type', type=str, default='W', help='Choose from W, Wplus_all, Wplus_one_layer.save the encoded real images in W(512) or W+(18,812) or select layer in W+')
		self.parser.add_argument('--save_latent_layer', type=int, default=None, help='save the selected layer from W+(18,512)')
